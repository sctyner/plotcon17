...
## Fitted SAOMs Example {.smaller}

Inspired by Steglich et al. 2010:

Network Evolution Parameter | Behavior (Drink, Smoke) Evolution Parameter
----------------------------|-----------------------------
Rate 1 ($\alpha_1$) | Rate 1 ($\lambda^D_1$, $\lambda^S_1$)
Rate 2 ($\alpha_2$) | Rate 2 ($\lambda^D_2$, $\lambda^S_2$)
Outdegree ($\beta_1$) | Shape: linear ($\gamma^D_1$, $\gamma^S_1$)
Reciprocity ($\beta_2$) | Shape: quadratic ($\gamma^D_2$, $\gamma^S_2$)
Preferential attachment ($\beta_3$) | Average similarity: ($\gamma^D_3$, $\gamma^S_3$)
Transitive ties ($\beta_4$) | Other behavior: ($\gamma^D_4$, $\gamma^S_4$)
\# of actors at distance 2 ($\beta_5$) |
Balance ($\beta_6$) |
Alcohol, smoking alter ($\beta_7$, $\beta_{10}$) |
Alcohol, smoking ego ($\beta_8$, $\beta_{11}$) |
Alcohol, smoking sim. ($\beta_9$, $\beta_{12}$) |
